    ...
    <div className="container" style={{ marginTop: "60px" }}>
      ...
      {view === "home" && (
        <div className="buttons">
          <button style={{marginLeft:'150px'}} onClick={() => setView("adminLogin")}>Admin Login</button>
          <button style={{marginLeft:'150px'}} onClick={() => setView("login")}>User Login</button>
          <button style={{marginLeft:'150px'}} onClick={() => setView("register")}>Register</button>
        </div>
      )}
